...
BASE_URL="http://doc-hub-api:8000/roman-leaders"
...
DATA_DIR="${SCRIPT_DIR}/../data_sets/roman_leaders"
...
echo -e "\n$JOB ${white}Creating${off} Roman leaders from ${cyan}$DATA_DIR${off}:"
$decorator_init
...
echo -e "$JOB ${green}Done.${off} Created up to 5 Roman leaders."
